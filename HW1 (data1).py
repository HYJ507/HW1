...
my_dict = ['Boston', 'Syracuse', 'NewYork','Chicago']

for l in my_dict:
    print('The value at position' + str(my_dict.index(l)) + 'is'+ str(l))
...
while True: 
    choice1 = input('please pick a vegetable')
   
    if choice1 in available_vegetables:
        print("Yes,I got it!")
        break
    else:
...
new_list5 = [x*2 for x in reversed(start_list)]
